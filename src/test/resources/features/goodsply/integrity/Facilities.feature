...
Feature: Manage facilities, dock doors, zones, and bins.
  ...
  Scenario: Create facilities Doors, Zones and Bins, Search
    ...
    When User open Dock Door tab
    And User add new Dock Door in facility
    ...
    And User add new Zones in facility
      ...
      | Auto_Fac_Zone_ | 99887    | Shipping | 2000        | Test Zone from Facility |
    ...
    And User add new Bins in facility
      ...
      | AutoSelect | Auto_Fac_Bin_ | Bulk    | AS001 | R001 |
  ...
  Scenario: Validate Zones
    ...
    And User add new Zones in facility
      | ZoneName       | ZoneCode | ZoneType | MaxCapacity | Description             |
      | Auto_Fac_Zone_ | 11223    | Picking  | 3500        | Test Zone from Facility |
    ...
    And User update Zone with bellow data
      | Facility | ZoneName                   | ZoneCode | ZoneType | Temperature | MaximumCapacity | Status   |
      | _IGNORE_ | Auto_Fac_Zone_Update_Name_ | 11225    | Storage  | _IGNORE_    | 200             | Inactive |
    ...
    And User create new Zone with bellow data
      | Facility   | ZoneName        | ZoneCode        | ZoneType | Temperature | MaximumCapacity | Status |
    ...
    When User open Zones page
    And User search for Zone
    And User Delete Zone
    And User open Facilities page
    And User search with newly created Facility
    And User click on newly created facility
    And User open Zones tab
  ...
  Scenario: Validate Bins
    ...
    # Verify new Bin in Facilities page
    And User open Facilities page
    And User search with newly created Facility
    And User click on newly created facility
    And User open Bins tab
